defmodule ShopifyWhatsappWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShopifyWhatsappWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShopifyWhatsappWeb.Gettext, "errors", msg, opts)
    end
  end
